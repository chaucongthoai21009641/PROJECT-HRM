            ...
            >
              {employeeShifts.map((shift) => (
                ...
                >
                  ...
                  >
                    <Button size="large" onClick={() => handleEditShift(shift)}>
                      {attendanceData[0]?.tgCheckIn
                        ? attendanceData[0]?.tgCheckIn.slice(0, 5)
                        : "?"}{" "}
                      -{" "}
                      {attendanceData[0]?.tgCheckOut
                        ? attendanceData[0]?.tgCheckOut.slice(0, 5)
                        : "?"}
                    </Button>
                  </Tooltip>
                </div>
